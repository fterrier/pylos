...
(deftest full-square-top-negamax-test
  (testing "Negamax on full square top"
    ...
    (is (= -7/6 (:best-possible-score (:negamax-values (negamax-choose-move (map->PylosGamePosition {:board pylos.core-test/full-board-test :player :black}) 6 score-middle-blocked)))))
    (is (= -5/6 (:best-possible-score (:negamax-values (negamax-choose-move (map->PylosGamePosition {:board pylos.core-test/full-board-test :player :white}) 6 score-middle-blocked)))))))
