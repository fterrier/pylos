...
(deftest full-square-top-negamax-test
  (testing "Negamax on full square top"
    ...
    (is (= -100 (:next-best-score (negamax-choose-move (map->GamePosition {:board pylos.core-test/full-board-test :player :black}) 6 score-middle-blocked))))
    (is (= -100 (:next-best-score (negamax-choose-move (map->GamePosition {:board pylos.core-test/full-board-test :player :white}) 6 score-middle-blocked))))))
